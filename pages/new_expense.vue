          ...
          <div class="px-4">
            <div class="flex">
              <div class="mb-4 ">
                ...
                <input
                  class=" appearance-none border  w-full py-4 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                  placeholder="0.0"
                />
              </div>
              ...
              <div class="mb-4 mx-4">
                ...
                <textarea
                  class=" appearance-none border   py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                  placeholder=""
                >
                </textarea>
              </div>
            ...
            <div class="mb-4 w-full pl-3 pr-2">
              <label class="block text-gray-700 text-sm mb-2" for="username">
                Code No:
              </label>
              <input
            ...
            <div class="mb-4 w-full pr-3 pl-2">
              <label class="block text-gray-700 text-sm mb-2" for="username">
                Date:
              </label>
              <input
