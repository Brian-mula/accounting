  ...
  <div class="flex justify-end items-end p-3">
      ...
      >
        <img
          ...
          class="h-5 w-5 mx-2"
        />
        <h4 class="text-white">New Appointment</h4>
      </nuxt-link>
    </div>
    ...
    <div
      class="flex justify-between border-b-4 bg-white rounded px-8 pt-2 pb-2 items-center mt-4"
    >
      <div>
